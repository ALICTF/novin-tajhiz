              ...
              <div className="relative h-12 w-20 sm:h-14 sm:w-24">
                <Image
                  ...
                  className={cn(
                    ...
                    /*
                      لوگوها تیره‌اند؛ روی زمینه تیره باید سفید شوند وگرنه محو
                      می‌شوند.

                      شرط درست کار کردن این فیلتر: فایل لوگو باید فقط «جوهر» را
                      نگه دارد و بقیه‌اش شفاف باشد. brightness(0) invert(1) هر
                      پیکسل مات را سفید می‌کند و فرقی بین جوهر و پس‌زمینه
                      نمی‌گذارد؛ اگر فایل پس‌زمینه سفید مات داشته باشد، همان
                      پس‌زمینه هم سفید می‌شود و لوگو داخل یک لکه گم می‌شود.

                      لوگوی نجمیه و بقیةالله دقیقاً همین مشکل را داشتند و
                      نسخه‌های `*-mono.png` از رویشان ساخته شد. اگر بعداً لوگوی
                      تازه‌ای اضافه شد و اینجا لکه سفید دیده شد، علتش همین است.
                    */
                    isDark
                      ? "brightness-0 invert"
